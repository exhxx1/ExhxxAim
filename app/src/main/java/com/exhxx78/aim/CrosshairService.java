...
public class CrosshairService extends Service {
    ...
    private boolean isAimVisible = true; // للتحكم بظهور الإيم

    @Override public IBinder onBind(Intent intent) { return null; }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        // هذا السطر يمنع النظام من إعادة تشغيل التطبيق إذا قفلته (يمنع الشبح)
    ...
    public void onCreate() {
        ...
        // --- الميزة الجديدة: زر إخفاء/إظهار الإيم ---
        ...
        btnToggleAim.setBackground(toggleBg); btnToggleAim.setPadding(10, 20, 10, 20);
        LinearLayout.LayoutParams toggleLp = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT); toggleLp.setMargins(0, 0, 0, 20); btnToggleAim.setLayoutParams(toggleLp);
        ...
        btnCloseAll.setBackground(closeBg); btnCloseAll.setPadding(10, 20, 10, 20); btnCloseAll.setLayoutParams(toggleLp);
